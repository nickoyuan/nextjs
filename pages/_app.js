...
function MyApp({ Component, pageProps }) {
  return(
    ...
    <header className="flex items-center px-4 py-3 border-b">
      <img
        ...
        src="https://pbs.twimg.com/profile_images/1267616128022351873/dZJpsWTD_400x400.jpg"
      />
      <p className="ml-6 text-lg font-extrabold">Latest Twitter</p>
    </header>
  ...
  <footer className="flex border-t">
    <a className="flex items-center justify-center w-1/4 py-3 text-center" href="">
      <HomeIcon className="w-7 h-7"></HomeIcon>
    </a>
    <a className="flex items-center justify-center w-1/4 py-3 text-center" href="">
    <SearchIcon className="w-7 h-7"></SearchIcon>
    </a>
    <a className="flex items-center justify-center w-1/4 py-3 text-center" href="">
    <BellIcon className="w-7 h-7"></BellIcon>
    </a>
    <a className="flex items-center justify-center w-1/3 py-3 text-center" href="">
    <MailboxIcon className="w-7 h-7"></MailboxIcon>
    </a>
  </footer>
    </div>
  );
